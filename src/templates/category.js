        ...
        <Layout>
            ...
            { products.edges.map(product => {
               return (  
                    ...
                    <Link to={'/'+product.node.slug}><img className="w-full" src={product.node.images[0].resize.src} alt="Sunset in the mountains"/></Link>
                    <div className="px-6 py-4">
                    <div className="font-bold text-xl mb-2">{product.node.product}</div>
